...
Add-HostsEntry "cm.jss18demo.localhost"
Add-HostsEntry "cd.jss18demo.localhost"
Add-HostsEntry "id.jss18demo.localhost"
Add-HostsEntry "www.jss18demo.localhost"
...
if ($InitEnv) {
    ...
    # CM_HOST
    Set-EnvFileVariable "CM_HOST" -Value "cm.jss18demo.localhost"

    # ID_HOST
    Set-EnvFileVariable "ID_HOST" -Value "id.jss18demo.localhost"

    # RENDERING_HOST
    Set-EnvFileVariable "RENDERING_HOST" -Value "www.jss18demo.localhost"
